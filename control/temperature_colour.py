...
temp_logfile_directory = "/home/chris/"

insta_logfile = "insta_temp.html"
insta_log_directory = "/home/chris/"
...
def insta_write(temp, pres, humid, insta_logfile, insta_log_directory):
	with open(insta_log_directory+insta_logfile, 'w') as instafile:
		write_line = "%.01f deg\t%.01f mBar\t%.01f percent" % (temp, pres, humid)
		instafile.write(html_pre + write_line + html_post)
